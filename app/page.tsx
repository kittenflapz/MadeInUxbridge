...
function Intro() {
  return (
    <section className="container mx-auto px-5 flex-col md:flex-row flex items-center md:justify-between mt-16 mb-16 md:mb-12 bg-gray-200 rounded-2xl shadow-lg p-10">
